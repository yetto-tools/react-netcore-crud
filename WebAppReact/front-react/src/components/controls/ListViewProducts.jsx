...
export const ListViewProducts = ({ children }) => {
...
export const ItemViewProducts = ({ t, products, handleUpdate, loading }) => {
  return (
    <>
...
ListViewProducts.propTypes = {
  children: PropTypes.node,
};

ItemViewProducts.propTypes = {
  t: PropTypes.func,
