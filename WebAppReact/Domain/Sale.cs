...
namespace WebAppReact.Domain
{
    public class Sale
    {
        ...
        public Sale(DataBaseContext dataBaseContext, ILogger<Sale> logger)
        {
        ...
        public async Task<DataSet> GetAll(int? pPage_size, int? pPage_number)
        {
            ...
            return await _dataBase.ExecuteStoredProcedureAsync("spVenta_GetAll", paramsSQL);
        }
        ...
        public async Task<DataSet> FindById(int pId, int? pEstado = null)
        {
            SqlParameter[] paramsSQL = new SqlParameter[]
            {
                new SqlParameter("@pID_SALE",   pId),
                new SqlParameter("@pESTADO",         pEstado),
            };

            return await _dataBase.ExecuteStoredProcedureAsync("spVenta_By", paramsSQL);
        }
        ...
        public async Task<DataSet> Search(string pValor, int pEstado = 1)
        {
            ...
            return await _dataBase.ExecuteStoredProcedureAsync("spVenta_Search", paramsSQL);
        }
        ...
        )
        {
            ...
            try
            {
                ...
                data = await _dataBase.ExecuteStoredProcedureAsync("spVenta_Save", paramsSQL);
            }
            catch (Exception ex)
            {
